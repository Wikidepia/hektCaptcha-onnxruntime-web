...
const parseConvTransposeAttributes = (node) => {
    ...
    return (0, attribute_with_cache_key_1.createAttributeWithCacheKey)({ autoPad, dilations, group, kernelShape, outputPadding, outputShape, pads, strides, ...activationAttributes });
};
