...
exports.MAX_CLIP = exports.MIN_CLIP = exports.GemmUtil = exports.PoolConvUtil = exports.ShapeUtil = exports.BroadcastUtil = exports.MatMulUtil = void 0;
...
class PoolConvUtil {
    ...
    static adjustPadsBasedOnAutoPad(inputDims, strides, dilations, kernelShape, pads, isChannelLast, autoPad) {
        ...
        for (let dim = 0; dim < inputDims.length - 2; dim++) {
            PoolConvUtil.adjustPadAndReturnShape(inputDims[dim + (isChannelLast ? 1 : 2)], strides[dim], dilations[dim], kernelShape[dim], pads, dim, dim + inputDims.length - 2, autoPad);
        }
    }
    /**
