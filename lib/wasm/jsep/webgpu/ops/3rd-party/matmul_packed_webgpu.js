...
exports.makeMatMulPackedSource = exports.makeMatMulPackedVec4Source = void 0;
...
const makeMatMulPackedVec4Source = (workPerThread, workgroupSize, transposeA = false, tileInner = 32, splitK = false, splitedDimInner = 32, isVectorA = false) => {
...
exports.makeMatMulPackedVec4Source = makeMatMulPackedVec4Source;
...
const readDataFromSubASnippet = (transposeA) => transposeA ? 'let ACached = mm_Asub[k][tileRow + innerRow];' : 'let ACached = mm_Asub[tileRow + innerRow][k];';
// sequentialAccessByThreads means sequential data in memory is accessed by
// threads, instead of a single thread (default behavior).
const makeMatMulPackedSource = (workPerThread, workgroupSize, transposeA = false, tileInner = 32, splitK = false, splitedDimInner = 32, sequentialAccessByThreads = false) => {
    ...
    for (var t = 0; t < numTiles; t = t + 1) {
      ...
      for (var k = 0; k < tileInner; k = k + 1) {
        ...
        for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
          let ACached = ${transposeA ? `mm_Asub[k][localRow + innerRow * ${workgroupSize[1]}];` :
...
exports.makeMatMulPackedSource = makeMatMulPackedSource;
//# sourceMappingURL=matmul_packed_webgpu.js.map